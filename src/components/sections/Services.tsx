        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <FadeInView delay={0.2}>
              <p className="font-body text-lg text-gray-500 leading-relaxed mb-10">
            ...
            <FadeInView delay={0.3}>
              <div className="relative p-8 rounded-2xl border-2 border-blue bg-white overflow-hidden">
                ...
                <p className="font-display text-7xl tracking-wider text-off-black leading-none mb-2">
                  £450
                </p>
                <p className="font-body text-sm text-gray-400">
                  First 3 clients only · 10-14 day turnaround
                </p>
                <div className="mt-6">
